...
mod tests {
    ...
    use segment::fixtures::payload_fixtures::{
        ...
        LON_RANGE, STR_DEEP_PROJ_KEY, STR_KEY, STR_PROJ_KEY, TEXT_KEY,
    };
    ...
    fn build_test_segments_nested_payload(
        ...
        let deep_nested_str_proj_key = format!(
            "{}.{}[].{}[].{}",
            STR_DEEP_PROJ_KEY, "nested_1", "nested_2", "nested_3"
        );
    ...
    #[test]
    fn test_nested_field_filter_cardinality_estimation() {
        let dir1 = Builder::new().prefix("segment1_dir").tempdir().unwrap();
        let dir2 = Builder::new().prefix("segment2_dir").tempdir().unwrap();
    ...
    #[test]
    fn test_nested_array_filter_cardinality_estimation() {
        let dir1 = Builder::new().prefix("segment1_dir").tempdir().unwrap();
        let dir2 = Builder::new().prefix("segment2_dir").tempdir().unwrap();
        ...
        let expected_primary_clause = FieldCondition::new_match(
            format!("{}.{}", STR_PROJ_KEY, nested_key), // full key expected
            "some value".to_owned().into(),
        );
    ...
    #[test]
    fn test_deep_nested_array_filter_cardinality_estimation() {
        let dir1 = Builder::new().prefix("segment1_dir").tempdir().unwrap();
        let dir2 = Builder::new().prefix("segment2_dir").tempdir().unwrap();
        ...
        // rely on test data from `build_test_segments_nested_payload`
        let nested_key = "nested_1[].nested_2[].nested_3";
        let nested_match =
            FieldCondition::new_match(nested_key.to_owned(), "some value".to_owned().into());
        let filter = Filter::new_must(Condition::new_nested(
            STR_DEEP_PROJ_KEY.to_string(),
            Filter::new_must(Condition::Field(nested_match)),
        ));
        ...
        let expected_primary_clause = FieldCondition::new_match(
            format!("{}.{}", STR_DEEP_PROJ_KEY, nested_key), // full key expected
            "some value".to_owned().into(),
        );
    ...
    #[test]
    fn test_double_nested_array_filter_cardinality_estimation() {
        let dir1 = Builder::new().prefix("segment1_dir").tempdir().unwrap();
        let dir2 = Builder::new().prefix("segment2_dir").tempdir().unwrap();
        ...
        // rely on test data from `build_test_segments_nested_payload`
        let nested_match_key = "nested_2[].nested_3";
        let nested_match =
        ...
        let expected_primary_clause = FieldCondition::new_match(
            format!("{}.nested_1[].{}", STR_DEEP_PROJ_KEY, nested_match_key), // full key expected
            "some value".to_owned().into(),
        );
    ...
    #[test]
    fn test_triple_nested_array_filter_cardinality_estimation() {
        let dir1 = Builder::new().prefix("segment1_dir").tempdir().unwrap();
        let dir2 = Builder::new().prefix("segment2_dir").tempdir().unwrap();
        ...
        let expected_primary_clause = FieldCondition::new_match(
            format!(
                "{}.nested_1[].nested_2[].{}",
                STR_DEEP_PROJ_KEY, nested_match_key
            ), // full key expected
            "some value".to_owned().into(),
        );
